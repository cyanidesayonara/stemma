...
Shipped in 2.x: session persistence (#55), metronome (#57), count-in (#78), recording (#79), animated startup (#76), MSIX / Store (#74), UI redesign and export extras (#92, #97, #98, #99, #100), release tooling (tag-driven `version.py` + manifest sync, CI on tags), automatic BPM/key detection (#42).

Open (all labeled `v3.0` on GitHub):
- [ ] Beat-synced metronome utilizing detected tempo/key grid (#42)
