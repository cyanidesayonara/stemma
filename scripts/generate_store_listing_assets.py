...
def _ensure_qt() -> None:
    ...
    # logo_arpeggio.svg uses live <text> elements. Qt's offscreen
    # platform registers no system fonts, so without loading them here
    # the letters rasterize as empty boxes and the store art ships with
    # tofu where "stemma" should be.
    for font_path in (
